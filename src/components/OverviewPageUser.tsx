...
const OverviewPageUser= () => {
  ...
  // Mock current user for permissions - you can replace this with actual user data
  const currentUser: User = {
    id: '1',
    name: fullName || '',
    username: fullName || '',
    permissions: ['request_access', 'view_resources', 'approve_requests', 'manage_team', 'full_access']
  };
