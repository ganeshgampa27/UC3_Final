...
const ApprovalsPage = () => {
  ...
  // Filter requests when cloud provider changes
  useEffect(() => {
    // This effect will run whenever cloudProvider changes
    // The filtering is handled in the filteredRequests computation below
  }, [cloudProvider]);
  ...
  // Enhanced filtering logic that includes cloud provider filtering
  const filteredRequests = React.useMemo(() => {
    return requests.filter((request) => {
      ...
      return matchesSearch && matchesCloudProvider;
    });
