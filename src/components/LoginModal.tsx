...
//           </div>
//           <h1 className="text-3xl font-bold text-foreground mb-2">UC3 Platform</h1>
//           <p className="text-muted-foreground">Unified Cloud Cost Control</p>
//         </div>
...
//               <div><strong>User:</strong> Suresh.Puttapaga@quadranttechnologies.com</div>
//               <div >Password: TestPassword123</div>
//             </div>
//             <div className="flex flex-col space-y-1">
//               <div><strong>Manager:</strong> Sudheer.Bellamkonda@quadranttechnologies.com</div>
//               <div >Password: TestPassword123</div>
//             </div>
//           </div>
//         </div>
...
const LoginModal = ({ open, onOpenChange, onSwitchToRegister, onForgotPassword }) => {
  const [email, setEmail] = useState('');
  const [password, setPassword] = useState('');
  const [showPassword, setShowPassword] = useState(false);
  const [isLoading, setIsLoading] = useState(false);
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader className="text-center">
          <DialogTitle className="text-2xl font-bold text-[#3d1f7a]">
            Login to Unifyd Cloud Platform
          </DialogTitle>
        ...
        <form onSubmit={handleLogin} className="space-y-4 mt-6">
          {error && (
            <div className="p-3 bg[#3d1f7a] border border-red-200 rounded-lg">
              <p className="text-[#3d1f7a] text-sm text-center">{error}</p>
            </div>
          )}
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <button
              ...
              className="text-sm text-[#3d1f7a]  hover:underline"
            >
              Forgot password?
            </button>
          </div>
          ...
          <Button
            type="submit"
            className="w-full h-12 bg-[#3d1f7a] hover:bg-[#3d1f7a]"
            disabled={isLoading}
          >
            {isLoading ? (
              <div className="flex items-center space-x-2">
